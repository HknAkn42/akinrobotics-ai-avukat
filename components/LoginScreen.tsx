...
import { ShieldCheck, ArrowRight, Lock, Database, Zap, Sparkles, User as UserIcon, Key, Loader2, AlertCircle } from 'lucide-react';
...
const LoginScreen: React.FC = () => {
  ...
  // Test/Demo amaçlı varsayılan dolu bilgiler (veya boş bırakılabilir)
  ...
  const handleLogin = async (e?: React.FormEvent) => {
    ...
    // Yapay bir yükleme gecikmesi ekleyerek sistemin "hazırlandığı" hissini verelim
    setTimeout(async () => {
      ...
      // Başarılı ise AuthContext state'i güncelleyecek ve App.tsx yeniden render olacak
    }, 1000);
  };
      ...
      <div className="relative z-10 w-full max-w-6xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="w-full max-w-md mx-auto bg-white/5 backdrop-blur-2xl border border-white/10 p-8 md:p-10 rounded-3xl shadow-2xl animate-fade-in-up relative overflow-hidden group">
              ...
              <div className="text-center mb-8 relative z-10">
                  ...
                  <p className="text-slate-400 text-sm">Panele erişmek için kimlik doğrulayın.</p>
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-5 relative z-10">
                  ...
                  <div className="space-y-1">
                      <label className="text-xs font-bold text-slate-400 ml-1 uppercase tracking-wider">Kullanıcı Adı</label>
                      <div className="relative group/input">
                          ...
                          <input 
                              ...
                              className="w-full pl-11 pr-4 py-3.5 bg-slate-900/50 border border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 outline-none text-slate-200 placeholder-slate-600 transition-all"
                  ...
                  <div className="space-y-1">
                      <label className="text-xs font-bold text-slate-400 ml-1 uppercase tracking-wider">Parola</label>
                      <div className="relative group/input">
                          <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-500 group-focus-within/input:text-blue-400 transition-colors">
                              <Key size={18}/>
                          </div>
                  ...
                  <button 
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-blue-900/50 flex items-center justify-center gap-2 group relative overflow-hidden mt-4"
                  >
                      {isLoading ? (
                          <>
                          ...
                          <>
                            Panele Bağlan <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform"/>
                          </>
                      )}
                  </button>
              </form>
              ...
              <div className="text-center mt-8 pt-6 border-t border-white/5">
                  <p className="text-[10px] text-slate-500 flex items-center justify-center gap-1.5">
                      <Lock size={10}/> 
                      Tüm veriler 256-bit şifreleme ile cihazınızda yerel olarak saklanır.
                  </p>
              </div>
          </div>
