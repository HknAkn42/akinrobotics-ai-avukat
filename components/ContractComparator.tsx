...
import { ArrowRightLeft, FileDiff, Upload, Columns, AlignJustify, MessageSquare, Send, User, Bot, AlertTriangle, CheckCircle, XCircle, Loader2, Sparkles, Trash2, FileText, BookTemplate, ChevronDown, ArrowLeft, RotateCcw, X, Undo2 } from 'lucide-react';
import { CompanyContext, DiffAnalysisResult, ChatMessage } from '../types';
...
const ContractComparator: React.FC<ContractComparatorProps> = ({ context }) => {
